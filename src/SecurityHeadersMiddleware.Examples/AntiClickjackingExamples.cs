...
namespace SecurityHeadersMiddleware.Examples {
    ...
    public class AntiClickjackingExamples {
        public void Examples() {
            ...
            // Add X-Frame-Options: ALLOW-FROM http://www.exmple.com   when the Request uri is the allow-from uri. Otherwise DENY will be sent.
            buildFunc.AntiClickjackingHeader("http://www.example.com");
            appbuilder.AntiClickjackingHeader("http://www.example.com");
        }
    }
}